...
@bot.on(indomie_cmd(outgoing=True, pattern="filter (.*)"))
...
@bot.on(indomie_cmd(outgoing=True, pattern="filters$"))
...
@bot.on(indomie_cmd(outgoing=True, pattern="stop ([\s\S]*)"))
...
@bot.on(indomie_cmd(outgoing=True, pattern="rmallfilters$"))
